...
export const brandConfigs: Record<string, BrandConfig> = {
  ...
  'kalinga-stone': {
    ...
    hero: {
      type: 'image',
      src: '/images/brands/kalinga-stone/hero.webp',
    ...
    productLines: [
      {
        ...
        metaDescription: 'Kalinga Stone Elixir UAE - Premium curated designer quartz surfaces for luxury residences. Available through Lapiz Blue, authorized Kalinga Stone distributor in the UAE, with slabs stocked by our sister company GCB UAE (gcbuae.com).',
        ...
        content: {
          ...
          howToChoose: {
            ...
            bullets: [
              ...
              'Match your interior style: Elixir designs range from dramatic dark marble-look surfaces (Noir Desir) to luminous white (Bianco Lasa). Ask Lapiz Blue to arrange a full-slab comparison before you decide',
              ...
              'Edge profiles: Elixir surfaces suit refined edge profiles - mitre joins for waterfall islands and eased edges for a clean, modern aesthetic. Experienced fabricators can produce all standard profiles',
          ...
          commonMistakes: {
            ...
            bullets: [
              ...
              'Not viewing full slabs before purchase - Elixir\'s premium veining patterns look entirely different at full slab scale vs small samples. Always ask Lapiz Blue for a full-slab viewing',
          ...
          trustSignals: {
            ...
            items: [
              ...
              { label: 'Local Partner', value: 'Lapiz Blue: authorized Kalinga Stone distributor, with Elixir slab viewings on request via sister company GCB UAE (gcbuae.com)' },
              { label: 'Certification', value: 'NSF / GREENGUARD certified - safe for residential and hospitality environments' },
              { label: 'Showroom', value: 'Private slab selection appointment - experience the full Elixir collection through sister company GCB UAE in Sharjah' },
            ],
          },
          faqs: [
            ...
            { question: 'Where can I buy Elixir quartz surfaces in the UAE?', answer: 'Lapiz Blue is an authorized Kalinga Stone distributor in the UAE, and our sister company Global Classic Building Materials (gcbuae.com) stocks the Elixir collection. Contact either team to schedule a private slab viewing.' },
            ...
            { question: 'What does Elixir premium quartz cost in Dubai?', answer: 'Elixir is positioned above standard quartz pricing, reflecting its premium design quality. Contact Lapiz Blue for a detailed quotation based on your specific project requirements.' },
            ...
            { question: 'Can I book a private viewing of the Elixir collection?', answer: 'Yes. Contact Lapiz Blue to arrange a private slab selection appointment, where you can view the full Elixir collection under controlled lighting.' },
            { question: 'Can Elixir surfaces be book-matched for feature walls?', answer: 'Yes. Sequential Elixir slabs can be book-matched for dramatic mirrored effect feature walls in living rooms, lobbies, and master bathrooms.' },
          ],
          cta: {
            title: 'Experience Kalinga Stone Elixir',
            subtitle: 'Discover the premium collection that redefines engineered quartz. Book a private slab viewing through Lapiz Blue.',
            checklist: [
              'View the complete Elixir collection in full-slab format',
              'Compare premium veining patterns under showroom lighting',
              'Get a bespoke project quotation with edge profile options',
              'Book a private viewing or contact us for a consultation',
            ],
          },
          brandCopy: {
            sections: [
              ...
              {
                title: 'The Lapiz Blue Premium Experience',
                content: 'As an authorized UAE distributor for Kalinga Stone, Lapiz Blue offers a premium experience worthy of the Elixir collection, with full slabs stocked by our sister company Global Classic Building Materials (gcbuae.com). Our team arranges full-slab viewings under proper lighting, helps you compare designs side by side, and works with you to select the perfect surface for your project. From slab supply to coordination with experienced fabricators and installers, every step is supported by our team.',
              },
            ],
          },
          suggestedImages: [
            { description: 'Kalinga Stone Elixir Grand Antique quartz surface hero shot', alt: 'Kalinga Stone Elixir Grand Antique premium quartz surface' },
            { description: 'Close-up detail of Elixir premium veining pattern', alt: 'Close-up of Kalinga Stone Elixir premium quartz veining detail' },
            { description: 'Kalinga Stone Elixir collection slabs on display', alt: 'Kalinga Stone Elixir collection slabs on display' },
          ],
          featuredProducts: [
      ...
      },
      {
        ...
        metaDescription: 'Kalinga Stone engineered quartz UAE - Non-porous, scratch-resistant quartz countertops & surfaces. Available through Lapiz Blue, authorized Kalinga Stone distributor in the UAE, with slabs stocked by our sister company GCB UAE (gcbuae.com).',
        ...
        content: {
          ...
          intro: 'Kalinga Stone engineered quartz combines 93% natural quartz with advanced polymer resins to deliver surfaces that are harder than granite, non-porous, and virtually maintenance-free. Available through Lapiz Blue - authorized Kalinga Stone distributor in the UAE, with slabs stocked by sister company GCB UAE (gcbuae.com) - these surfaces are ideal for kitchen countertops, bathroom vanities, bar tops, reception desks, and commercial cladding. Every slab is manufactured under controlled factory conditions, ensuring consistent colour, pattern, and thickness that natural stone simply cannot match.',
          applications: {
            title: 'Applications & Best-Fit Scenarios',
            items: [
          ...
          howToChoose: {
            ...
            bullets: [
              'Consider your colour palette: Kalinga Stone offers 100+ shades - from Calacatta-look whites to deep solid blacks. Ask Lapiz Blue to arrange a full-size slab comparison under natural and artificial light',
              ...
              'Heat resistance: Quartz resists temperatures up to 150 °C, but always use trivets for hot pans straight off the hob to prevent thermal shock',
              'Indoor use only: Engineered quartz is designed for indoor use. Prolonged UV exposure can cause colour shift. For outdoor surfaces, consider natural stone or porcelain alternatives',
              'Edge profiles: Choose from flat polished, bevelled, bullnose, ogee, and waterfall edges. Experienced fabricators can produce all standard profiles',
              'Maintenance: Simply wipe with a damp cloth and mild soap. Avoid abrasive cleaners and harsh chemicals like bleach or acetone',
            ],
          },
          commonMistakes: {
            title: 'Common Mistakes to Avoid',
            bullets: [
              'Choosing colour from a small sample chip - Always ask Lapiz Blue to arrange a full-slab viewing. Pattern scale and colour undertones look completely different at full size',
          ...
          trustSignals: {
            ...
            items: [
              ...
              { label: 'Local Partner', value: 'Lapiz Blue: authorized Kalinga Stone distributor, with 128 shades ex-stock at sister company GCB UAE (gcbuae.com)' },
              { label: 'Track Record', value: 'Over 670 luxury residential projects completed across the UAE' },
              { label: 'Showroom', value: 'Free slab selection appointment - view full slabs through sister company GCB UAE in Sharjah' },
            ],
          },
          faqs: [
            { question: 'Where can I buy Kalinga Stone quartz in UAE?', answer: 'Lapiz Blue is an authorized Kalinga Stone distributor in the UAE, and our sister company Global Classic Building Materials (gcbuae.com) stocks full slabs ex-stock. Contact either team to schedule a slab selection appointment.' },
            ...
            { question: 'Can I see the full slabs before buying?', answer: 'Yes. Full-size slabs are available to view through Lapiz Blue so you can inspect colour, veining, and pattern before making a decision.' },
          ...
          cta: {
            title: 'Ready to Explore Kalinga Stone Quartz?',
            subtitle: 'Contact Lapiz Blue to view full slabs, compare finishes, and get a free project quotation.',
            checklist: [
              'View 100+ quartz designs in full-slab format',
              'Compare polished, honed, and textured finishes side by side',
              'Get a free project quotation with edge profile options',
              'Book a showroom visit or contact us for a consultation',
            ],
          },
          brandCopy: {
            sections: [
              ...
              {
                title: 'Lapiz Blue and GCB UAE - Your Authorized Kalinga Stone Partners',
                content: 'As an authorized distributor for Kalinga Stone in the UAE, Lapiz Blue offers the complete surface journey together with our sister company Global Classic Building Materials (gcbuae.com): guided slab selection from 128 shades ex-stock, coordination with experienced fabricators and installers, and UAE-wide delivery. Whether you are a homeowner upgrading a kitchen, an interior designer specifying for a villa project, or a contractor outfitting a commercial tower, we deliver material, expertise, and after-sales support under one roof.',
              },
            ],
          },
          suggestedImages: [
            { description: 'Kalinga Stone quartz kitchen countertop in modern Dubai villa', alt: 'Kalinga Stone quartz kitchen countertop in modern Dubai villa' },
            { description: 'Close-up of Calacatta-look engineered quartz slab', alt: 'Close-up of Calacatta-look engineered quartz slab' },
            { description: 'Kalinga Stone quartz slabs on display', alt: 'Kalinga Stone quartz slabs on display' },
          ],
          featuredProducts: [
      ...
      },
      {
        ...
        metaDescription: 'Kalinga Stone engineered marble UAE - Consistent marble-look surfaces without the porosity of natural stone. Authorized distributor: Lapiz Blue, with slabs stocked by sister company GCB UAE (gcbuae.com).',
        ...
        content: {
          ...
          howToChoose: {
            title: 'How to Choose the Right Engineered Marble',
            bullets: [
              ...
              'Kalinga Stone offers slabs up to 3200 × 1600 mm, allowing minimal joints for large installations. Custom cutting is handled by experienced local fabricators',
              ...
              'Our factory produces sequential slabs that can be book-matched for a dramatic mirrored effect on feature walls and floors',
            ],
          },
          commonMistakes: {
            title: 'Common Mistakes to Avoid',
            bullets: [
              ...
              'Ordering from small samples without viewing full slabs - Ask Lapiz Blue to arrange a full-size slab viewing. Veining patterns and colour depth look completely different at scale',
            ],
          },
          trustSignals: {
            title: 'What You Can Expect',
            items: [
              ...
              { label: 'Local Partner', value: 'Lapiz Blue: authorized Kalinga Stone distributor with UAE-wide delivery, supported by sister company GCB UAE (gcbuae.com)' },
          ...
          faqs: [
            { question: 'Where can I buy Kalinga Stone engineered marble in the UAE?', answer: 'Lapiz Blue is an authorized Kalinga Stone distributor in the UAE, working alongside our sister company Global Classic Building Materials (gcbuae.com). Contact either team to arrange a viewing.' },
            { question: 'Is engineered marble cheaper than natural marble?', answer: 'Engineered marble is generally more cost-effective than premium natural marble grades (Calacatta, Statuario) while offering better consistency and lower lifetime maintenance costs.' },
            ...
            { question: 'Do you provide installation services?', answer: 'Yes. Lapiz Blue coordinates fabrication and installation through experienced partner teams across Dubai, Abu Dhabi, Sharjah, and all Emirates.' },
          ...
          cta: {
            ...
            subtitle: 'Book a free showroom appointment to explore the full collection and get a project quotation tailored to your requirements.',
            checklist: [
              'Explore the full engineered marble collection in our showroom',
              'Request a book-matched slab pairing for feature walls',
              'Get a free project quotation with fabrication and installation',
              'Schedule a visit or contact us for a consultation',
            ],
          },
          brandCopy: {
            sections: [
              ...
              {
                title: 'From Slab Selection to Installation - Lapiz Blue Supports Every Step',
                content: 'As an authorized Kalinga Stone distributor in the UAE, Lapiz Blue offers a complete experience: guided slab selection, precision cutting through experienced fabrication partners, and coordinated professional installation, with slabs stocked by sister company GCB UAE (gcbuae.com). We serve homeowners, interior designers, architects, and contractors - from single-kitchen renovations to multi-tower commercial fit-outs.',
              },
            ],
          },
          suggestedImages: [
            { description: 'Kalinga Stone engineered marble flooring in Dubai hotel lobby', alt: 'Kalinga Stone engineered marble flooring in Dubai hotel lobby' },
            { description: 'Book-matched engineered marble feature wall', alt: 'Book-matched engineered marble feature wall' },
            { description: 'Engineered marble slab being cut to size during fabrication', alt: 'Engineered marble slab being cut to size during fabrication' },
          ],
          featuredProducts: [
      ...
      },
      {
        ...
        metaDescription: 'Kalinga Stone terrazzo surfaces UAE - Venetian, Palladiana, Elite, Roma & Cafe collections. Authorized distributor: Lapiz Blue, with slabs stocked by sister company GCB UAE (gcbuae.com).',
        ...
        content: {
          ...
          howToChoose: {
            title: 'How to Choose the Right Terrazzo Collection',
            bullets: [
              'Five collections to choose from: Venetian (fine chips, classic elegance), Palladiana (large irregular marble pieces), Elite (medium chips, contemporary), Roma (warm Mediterranean tones), and Cafe (earthy, organic palettes inspired by coffee-house interiors)',
              'For modern minimalist interiors, the Elite collection with its clean, medium-chip composition and neutral colour palette works beautifully',
              'Factory-made terrazzo is primarily designed for indoor use. For covered outdoor areas with minimal UV exposure, consult our technical team for suitable options',
          ...
          commonMistakes: {
            ...
            bullets: [
              ...
              'Under-specifying grout colour for tiled terrazzo - Grout colour dramatically affects the final look. Request a mock-up or sample layout from Lapiz Blue before committing to a grout shade',
          ...
          trustSignals: {
            ...
            items: [
              ...
              { label: 'Local Partner', value: 'Lapiz Blue: authorized UAE distributor with terrazzo slab viewings on request' },
          ...
          faqs: [
            { question: 'Where can I buy Kalinga Stone terrazzo in the UAE?', answer: 'Lapiz Blue is an authorized Kalinga Stone distributor in the UAE, and our sister company Global Classic Building Materials (gcbuae.com) stocks all five terrazzo collections. Contact either team to explore them.' },
            { question: 'What is Palladiana terrazzo?', answer: 'Palladiana features large, irregular marble pieces set in a contrasting cement or resin matrix. It creates a bold, artistic look that is perfect for statement floors and feature walls.' },
            ...
            { question: 'How is terrazzo installed?', answer: 'Terrazzo slabs are fabricated to size and installed like natural stone. Tiles are laid with appropriate adhesive and grouted. Lapiz Blue coordinates full installation through experienced partner teams.' },
            ...
            { question: 'Do you offer terrazzo samples?', answer: 'Yes. Contact Lapiz Blue to request samples of any Kalinga Stone terrazzo collection or to arrange a full-size slab viewing.' },
          ],
          cta: {
            title: 'Explore the Kalinga Stone Terrazzo Collections',
            subtitle: 'From Venetian elegance to Palladiana drama - discover all five collections through Lapiz Blue.',
            checklist: [
              'View all five terrazzo collections side by side',
              'Compare chip sizes, colour palettes, and finishes',
              'Get expert advice on collection pairing for your project',
          ...
          brandCopy: {
            sections: [
              ...
              {
                title: 'Lapiz Blue - Terrazzo Experts in the UAE',
                content: 'Our team helps you compare all five Kalinga Stone terrazzo collections and select the right collection, chip size, and colour for your project - whether it\'s a single bathroom floor or an entire hotel lobby. From slab selection through fabrication and installation coordination, Lapiz Blue is your single point of contact for terrazzo surfaces in the UAE, with all five collections stocked by our sister company Global Classic Building Materials (gcbuae.com).',
              },
            ],
          },
          suggestedImages: [
            { description: 'Kalinga Stone Venetian terrazzo floor in luxury Dubai apartment', alt: 'Kalinga Stone Venetian terrazzo floor in luxury Dubai apartment' },
            { description: 'Palladiana terrazzo slab close-up showing large marble pieces', alt: 'Palladiana terrazzo slab close-up showing large marble pieces' },
            { description: 'Kalinga Stone terrazzo collection slabs on display', alt: 'Kalinga Stone terrazzo collection slabs on display' },
          ],
          featuredProducts: [
    ...
    extendedContent: {
      brandStory: 'Kalinga Stone is India\'s premier manufacturer of engineered quartz, engineered marble, and terrazzo surfaces - operating one of Asia\'s largest production facilities with Italian Breton technology and German engineering. From a single factory in Rajasthan, Kalinga Stone exports to over 40 countries, trusted by architects and developers for consistent quality, vast colour ranges, and surfaces that perform as beautifully as they look. In the UAE, Kalinga Stone is available through Lapiz Blue, authorized distributor, and our sister company Global Classic Building Materials (GCB UAE), certified KalingaStone reseller with 128 shades ex-stock as full slabs, expert consultation, and coordinated fabrication and installation.',
      whyLapizBlue: 'Lapiz Blue is an authorized Kalinga Stone distributor in the UAE and connects buyers with the full range through our sister company Global Classic Building Materials (gcbuae.com). From initial material selection and full-slab viewings to precision fabrication and on-site installation through experienced stone specialists, the entire journey is coordinated within the Lapiz Group. Whether you are an architect specifying for a tower project or a homeowner choosing a kitchen countertop, you get direct access to Kalinga Stone\'s full product range - engineered quartz, engineered marble, and five terrazzo collections - with local expertise and after-sales support.',
      stats: [
        { value: '200+', label: 'Engineered Stone Designs', iconType: 'stones' },
        { value: '300+', label: 'Natural & Terrazzo Options', iconType: 'wood' },
        { value: '670+', label: 'Luxury Homes Completed', iconType: 'home' },
        { value: '420+', label: 'B2B Projects (MENA)', iconType: 'building' },
      ],
      capabilities: {
        intro: 'Kalinga Stone combines world-class manufacturing with Lapiz Blue\'s local expertise to deliver a seamless surface experience - from slab selection to finished installation - across the UAE.',
        items: [
          {
            title: 'Precision Craftsmanship',
            subtitle: 'Where Vision Meets Mastery',
            content: 'Experienced master craftsmen transform Kalinga Stone slabs into finished works of art. From chamfered edges and book-matched designs to waterfall islands and curved reception desks, every piece is fabricated with meticulous precision and hand-finished detailing.',
          },
          {
            title: 'State-of-the-Art Showroom & Facility',
            subtitle: '100,000 sq ft Lifestyle Gallery',
            content: 'Explore and select from Kalinga Stone\'s complete range of engineered quartz, engineered marble, and terrazzo surfaces with Lapiz Blue. View full slabs in book-match patterns and visualize the beauty inherent in each piece before you commit.',
            image: '/images/brands/kalinga-stone/facility.webp',
          },
          {
            title: 'Factory-Direct Quality Assurance',
            subtitle: 'From Kalinga Stone\'s Plant to Your Project',
            content: 'Every Kalinga Stone slab is manufactured under controlled factory conditions using Italian Breton technology, ensuring consistent density, colour accuracy, and structural integrity. Lapiz Blue and sister company Global Classic Building Materials maintain direct supply chain access through the official KalingaStone channel, guaranteeing authentic Kalinga Stone products for every UAE project.',
          },
        ],
      },
      uniqueSection: {
