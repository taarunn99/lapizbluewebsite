...
export default function Error({
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-b from-[#87CEEB] via-[#B8DCF0] to-white">
      ...
      {/* Large "500" watermark - 5s in #161925, 0 in white */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none -translate-y-20 md:-translate-y-28">
        <div className="flex items-center" style={{ letterSpacing: '0.1em' }}>
          <span className="text-[40vw] md:text-[30vw] font-bold leading-none text-[#161925]">5</span>
          <span className="text-[40vw] md:text-[30vw] font-bold leading-none text-white">0</span>
          <span className="text-[40vw] md:text-[30vw] font-bold leading-none text-[#161925]">0</span>
        </div>
      </div>
      ...
      <div className="relative z-20 text-center -mt-8 md:-mt-12 px-4">
        ...
        <div className="flex items-center justify-center gap-3">
          <button
            onClick={() => reset()}
            className="group inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-[#161925] rounded-full shadow-md hover:shadow-lg transition-all duration-300 font-medium text-sm sm:text-base hover:scale-105 text-white hover:bg-[#406E8E]"
          >
            Try Again
          </button>
          <Link
