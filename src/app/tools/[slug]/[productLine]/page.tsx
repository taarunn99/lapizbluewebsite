...
export async function generateMetadata({
  ...
  return {
    title: `${productLine.name} - ${tool.name} | Lapiz Blue`,
    description: productLine.metaDescription,
    openGraph: {
      title: `${productLine.name} - ${tool.name}`,
      description: productLine.metaDescription,
  ...
  return (
    <main className={`${manrope.className} bg-white text-[#23395B]`}>
      ...
      <section
        ...
        style={{ backgroundColor: `${tool.theme.primary}15` }}
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Our team is here to help you choose the right {productLine.name.toLowerCase()} for your project.
