    ...
    <main className={`${manrope.className} relative bg-white text-[#1a2b5f]`}>
      ...
      <section className="relative h-[60vh] md:h-[70vh] lg:h-[80vh] w-full bg-white flex items-center justify-center">
        ...
        <div className="relative w-full">
          ...
          {/* Flip Logo Card - AkzoNobel & Dulux */}
          <div className="mb-6">
            <FlipLogoCard
      ...
      {/* Product Cards Section - Color change cards */}
      ...
      <section className="py-8 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link
            href="/brands"
            className="inline-flex items-center text-gray-600 hover:text-[#FF6200] transition-colors"
          >
            <svg
              className="w-5 h-5 mr-2"
              fill="none"
