    ...
    <main className={`${manrope.className} bg-white text-[#1A1A1A]`}>
      ...
      <section className="relative h-[60vh] md:h-[70vh] lg:h-[80vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          {/* Overlay gradient - Laticrete Blue theme */}
          <div className="absolute inset-0 bg-gradient-to-b from-[#0072CE]/80 via-[#0072CE]/50 to-[#0072CE]/30" />
        </div>
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          {brand.website && (
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#0072CE] transition-all hover:bg-[#E6F3FF] hover:scale-105 shadow-lg"
            >
              <svg
                className="w-5 h-5"
                fill="none"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {brand.productLines.map((productLine) => (
              <Link
                ...
                className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-white p-6 shadow-md transition-all duration-300 hover:shadow-xl border border-gray-100 hover:border-[#0072CE]/40"
              >
                <div className="mb-4">
                  <div className="inline-flex rounded-full p-3 bg-[#0072CE]/10 group-hover:bg-[#0072CE]/20 transition-colors">
                    <svg
                      className="h-6 w-6 text-[#0072CE]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <h3 className="mb-2 text-xl font-semibold text-[#1A1A1A] group-hover:text-[#0072CE] transition-colors">
                  {productLine.name}
                </h3>
                ...
                {/* Hover indicator */}
                <div className="absolute bottom-0 left-0 h-1 w-0 bg-[#0072CE] transition-all duration-300 group-hover:w-full" />
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-6 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <a
            href="/certificates/laticrete-distributor-certificate.pdf"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <div className="flex items-center gap-4">
              <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#0072CE]/20 flex items-center justify-center">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-[#0072CE]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-[#0072CE] to-[#005BA3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            ...
            specifications, and project recommendations for Laticrete products.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-[#0072CE] bg-white rounded-lg transition-all duration-200 hover:bg-[#E6F3FF] hover:shadow-lg hover:scale-105"
            >
              Contact Our Team
            </Link>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold border-2 border-white text-white rounded-lg transition-all duration-200 hover:bg-white hover:text-[#0072CE] hover:shadow-lg hover:scale-105"
            >
              <svg
      ...
      <section className="py-8 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link
            href="/brands"
            className="inline-flex items-center text-gray-600 hover:text-[#0072CE] transition-colors"
          >
            <svg
              className="w-5 h-5 mr-2"
              fill="none"
