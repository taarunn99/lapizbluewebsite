...
// Fallback icons using inline SVG - white color for contrast on blue background
const FallbackIcon = ({ name }: { name: string }) => {
  const icons: Record<string, React.ReactElement> = {
    "Swimming Pools": (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <path d="M8 48C12 44 16 48 20 44C24 48 28 44 32 48C36 44 40 48 44 44C48 48 52 44 56 48" stroke="white" strokeWidth="3" strokeLinecap="round"/>
        <path d="M8 56C12 52 16 56 20 52C24 56 28 52 32 56C36 52 40 56 44 52C48 56 52 52 56 56" stroke="white" strokeWidth="3" strokeLinecap="round"/>
        <rect x="12" y="16" width="40" height="24" rx="4" stroke="white" strokeWidth="3"/>
        <path d="M22 28V24M32 28V20M42 28V24" stroke="white" strokeWidth="3" strokeLinecap="round"/>
      </svg>
    ),
    "Wet Areas": (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <path d="M32 8C32 8 16 24 16 36C16 44.837 23.163 52 32 52C40.837 52 48 44.837 48 36C48 24 32 8 32 8Z" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M28 40C26.343 40 25 38.657 25 37C25 34 28 31 28 31C28 31 31 34 31 37C31 38.657 29.657 40 28 40Z" fill="white"/>
        <path d="M38 36C36.343 36 35 34.657 35 33C35 30 38 27 38 27C38 27 41 30 41 33C41 34.657 39.657 36 38 36Z" fill="white"/>
      </svg>
    ),
    "Commercial\nFloors": (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <rect x="8" y="12" width="48" height="40" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M8 32H56" stroke="white" strokeWidth="2"/>
        <path d="M8 42H56" stroke="white" strokeWidth="2"/>
        <path d="M8 22H56" stroke="white" strokeWidth="2"/>
        <path d="M20 12V52M32 12V52M44 12V52" stroke="white" strokeWidth="2"/>
      </svg>
    ),
    "Exterior\nInstallations": (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <path d="M32 8L8 24V56H56V24L32 8Z" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M24 56V40H40V56" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
        <circle cx="32" cy="28" r="6" stroke="white" strokeWidth="3"/>
        <path d="M4 24L32 4L60 24" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
    "Heavy\nTraffic Areas": (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <rect x="14" y="20" width="36" height="28" rx="4" stroke="white" strokeWidth="3"/>
        <circle cx="22" cy="48" r="6" stroke="white" strokeWidth="3"/>
        <circle cx="42" cy="48" r="6" stroke="white" strokeWidth="3"/>
        <path d="M14 32H50" stroke="white" strokeWidth="2"/>
        <path d="M20 12H44L50 20H14L20 12Z" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M32 20V32" stroke="white" strokeWidth="2"/>
      </svg>
    ),
  };
